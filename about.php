...
<body>
    ...
    <!--/Navbar-->
    <div class="jumbotron jumbotron3 jumbotron-fluid mb-0">
            <div class="container">
                <img src="assets/img/avatar.png" width="250" alt="" class="mt-4">
                <h1 class="display-4">Work with me</h1>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalCenterTitle">Let's Work!</h5>
